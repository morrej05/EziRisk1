...
export const PUBLIC_LEGAL_DETAILS = {
  ...
  icoRegistrationNumber: '00014056799',
  contactEmail: SUPPORT_CONFIG.email,
  website: 'https://www.ezirisk.co.uk',
  phone: '+44 01904 922362',
  footerStatement: `EziRisk is operated by EziSoft Solutions. ICO registration number: 00014056799. Contact: ${SUPPORT_CONFIG.email} or +44 01904 922362.`,
