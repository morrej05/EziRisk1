...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#0E5F8C] to-[#0B3E63]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        <p className="text-xl md:text-2xl text-neutral-200 mb-12 max-w-3xl mx-auto leading-relaxed">
          ...
          multi-jurisdiction support, consistent insurer-grade outputs, and AI-assisted portfolio analysis.
        </p>
