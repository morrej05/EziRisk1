...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-950 via-neutral-900 to-slate-900">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        <div className="flex flex-col gap-3 justify-center items-center">
          ...
          <p className="text-sm text-neutral-300">No payment required</p>
        </div>

        <div className="mt-16 text-neutral-300 text-sm md:text-base">
          FRA • FSD • DSEAR / ATEX • Risk Engineering • Portfolio analysis • AI-assisted recommendations
        </div>
      </div>
    </section>
  );
