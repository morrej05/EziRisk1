...
const plans = [
  {
    title: 'Free Trial',
    price: 'Free',
    details: ['14-day trial', '1 user', 'Up to 5 reports per month'],
  ...
  },
  {
    ...
    details: ['For individual consultants', 'Up to 2 users', 'Up to 10 reports per month'],
  ...
  },
  {
    ...
    details: ['For teams and consultancies', 'Up to 5 users', 'Up to 30 reports per month'],
