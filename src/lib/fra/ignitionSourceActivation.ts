...
export const HAZARD_TO_SOURCE_MAPPINGS: HazardToSourceMapping[] = [
  ...
  { broadField: 'high_risk_activities', broadKey: 'commercial_kitchens', sourceKey: 'cooking', label: 'Commercial kitchen/cooking → Cooking equipment source card' },
  { broadField: 'high_risk_activities', broadKey: 'hot_work', sourceKey: 'hot_works', label: 'Hot works → Hot works source card' },
  { broadField: 'high_risk_activities', broadKey: 'contractor_works', sourceKey: 'hot_works', label: 'Contractor works → Hot works/contractor ignition controls card' },
  { broadField: 'high_risk_activities', broadKey: 'maintenance_activities', sourceKey: 'hot_works', label: 'Maintenance activities → Hot works/contractor ignition controls card' },
  { broadField: 'high_risk_activities', broadKey: 'lithium_ion_charging', sourceKey: 'electrical', label: 'Lithium-ion charging → Electrical ignition source card' },
