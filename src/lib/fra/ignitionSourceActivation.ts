...
export const HAZARD_TO_SOURCE_MAPPINGS: HazardToSourceMapping[] = [
  ...
  { broadField: 'high_risk_activities', broadKey: 'hot_work', sourceKey: 'hot_works', label: 'Hot work → hot work permit and ignition source follow-up' },
  { broadField: 'high_risk_activities', broadKey: 'lithium_ion_charging', sourceKey: 'electrical', label: 'Lithium-ion charging → battery charging / electrical ignition source card' },
