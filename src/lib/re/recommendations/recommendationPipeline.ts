...
const FACTOR_SPECIFIC_FALLBACKS: Record<string, FallbackContent> = {
  ...
  re06_fp_sprinklers_warranted_absent: {
    ...
    observation_text: 'No automatic sprinkler system is installed in this building. The occupancy, construction, and hazard profile indicates that building-wide suppression or an equivalent engineered fire-control strategy is warranted. The absence of automatic suppression represents a material protection deficiency.',
    action_required_text: 'Review the need for building-wide automatic sprinkler protection or equivalent engineered fire-control measures, taking account of the construction type and combustibility, total uncompartmented fire area, process and storage hazards, special-hazard dependencies, and business interruption exposure. The review should confirm the appropriate protection basis, design standard, water supply arrangement, impairment controls and implementation programme.',
    hazard_text: 'Without effective building-wide automatic suppression or equivalent engineered fire-control measures, a fire developing beyond any localised protection zone could spread through the uncompartmented building envelope, resulting in major property damage and prolonged business interruption. The absence of area-level suppression is a material underwriting exposure.',
  },
